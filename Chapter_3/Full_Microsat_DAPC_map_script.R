...
body <- read.csv("C:/Users/Dan/Dropbox/PhD/Dan's PhD (Shared)/Data/Microsatellites/DAPC/Complete dataset outputs/Whole EU 4 clusters/WholeEU_Clustermemberships.csv", header = T)  ## Load my cluster membership data file.
head(body)
